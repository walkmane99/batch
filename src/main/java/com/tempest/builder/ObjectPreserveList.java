...
public class ObjectPreserveList implements List<ObjectPreserve> {
    ...
    private List<ObjectPreserve> list;

    public ObjectPreserveList() {
        list = new ArrayList<>();
    }
    ...
    public <T> T get(Class<T> targetClass) throws FaildCreateObjectException {
        return (T) this.list.stream().filter(p -> p.getTargetClass() == targetClass)
                .map(rethrowFunction(p -> p.create())).findFirst().orElse(null);
    }
     ...
     */
    @Override
    public Iterator<ObjectPreserve> iterator() {
     ...
     *
     * @param objectPreserve element to be appended to this list
     ...
     */
    @Override
    public boolean add(ObjectPreserve objectPreserve) {
        return list.add(objectPreserve);
    }
     ...
     */
    @Override
    public boolean addAll(Collection<? extends ObjectPreserve> c) {
     ...
     */
    @Override
    public boolean addAll(int index, Collection<? extends ObjectPreserve> c) {
     ...
     */
    @Override
    public ObjectPreserve get(int index) {
     ...
     */
    @Override
    public ObjectPreserve set(int index, ObjectPreserve element) {
     ...
     */
    @Override
    public void add(int index, ObjectPreserve element) {
     ...
     */
    @Override
    public ObjectPreserve remove(int index) {
     ...
     */
    @Override
    public ListIterator<ObjectPreserve> listIterator() {
     ...
     */
    @Override
    public ListIterator<ObjectPreserve> listIterator(int index) {
     ...
     */
    @Override
    public List<ObjectPreserve> subList(int fromIndex, int toIndex) {
