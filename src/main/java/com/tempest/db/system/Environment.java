...
public class Environment {
    ...
    /**
     * 環境変数からの取得を試す。 下記フォーマットの文字列が与えられた場合、環境変数の取得を試み、取得した値を返します。 ${<環境変数>:初期値}
     *
     * 環境変数の値が取得できなかった場合、初期値の値を返します。 また、上記フォーマットに従っていない場合、引数をそのまま返します。
     *
